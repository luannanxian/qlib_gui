"""
Pytest configuration for Task Scheduling Repository tests.

Provides database fixtures for testing task repositories with MySQL.
"""
...
def get_engine_config():
    """
    Get database engine configuration for MySQL.
...
def pytest_report_header(config):
    ...
    return [
        f"Test Database: MySQL",
        f"Database URL: {TEST_DATABASE_URL}",
        f"Pool Size: {TEST_DB_POOL_SIZE}",
